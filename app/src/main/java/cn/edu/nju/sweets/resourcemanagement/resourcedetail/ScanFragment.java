...
public class ScanFragment extends BaseFragment implements QRCodeView.Delegate, View.OnClickListener {
    ...
    public void onScanQRCodeSuccess(String result) {
        ...
        Toast.makeText(mActivity,"扫描结果为：" + result,Toast.LENGTH_LONG).show();
        vibrate();
...
//
//        String ambientBrightnessTip = "轻触点亮 ⚡️";
//        if (isDark) {
...
//        }
//        if(isDark){
//            flash_light.setVisibility(View.VISIBLE);
//        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.flash_light:
                ...
                if(flash_light.getText().toString().contains("点亮")){
                    mZXingView.openFlashlight();
                    flash_light.setText("轻触关闭 ⚡️");
                }else{
                    mZXingView.closeFlashlight();
                    flash_light.setText("轻触点亮 ⚡️");
                }
